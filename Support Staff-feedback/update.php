...
<body>
  ...
  <div class="anu-Main">
    <div class="anu-Header">
      <h2 class="anu-Trivago">Trivago</h2>
      <a class="anu-Home" href="#">Home</a>
      <a class "anu-Services" href="#">Services</a>
      <a class="anu-Contact" href="#">Contact</a>
      <a class="anu-AboutUs" href="#">About Us</a>
    </div>
    <div class="mapouter">
